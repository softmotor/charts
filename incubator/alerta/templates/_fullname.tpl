...
Usage: 'name: "{{- template "alerta.fullname" . -}}"'
*/ -}}
...
{{- /*
alerta.fullname.unique adds a random suffix to the unique name.

This takes the same parameters as alerta.fullname

*/ -}}
{{- define "alerta.fullname.unique" -}}
  {{ template "alerta.fullname" . }}-{{ randAlphaNum 7 | lower }}
{{- end }}
